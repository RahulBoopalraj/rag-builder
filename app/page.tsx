  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
        <section className="w-full min-h-[calc(100dvh-3.5rem)] flex items-center justify-center">
            ...
            <div className="grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <h1 className="lg:leading-tighter text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem]">
                  Build AI-powered chatbots without <span className="text-blue-500">a single line of code!</span>
                </h1>
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Create intelligent chatbots without writing a single line of
                  code. Engage your customers with automated conversational
                  experiences. Let your imagination flow while we handle the
                  technology.
                </p>
                <Link
